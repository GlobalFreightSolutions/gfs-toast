...
class GfsToast extends mixinBehaviors(IronOverlayBehavior, PolymerElement) {
    ...
    static get properties() {
        return {
            ...
            * Possible values are "left", "right", "center", "auto".
            */
            horizontalAlign: {
                type: String,
                value: 'left'
    ...
    */
    ...
    _renderOpened() {
        this.classList.add('gfs-toast-open');
        // from `IronOverlayBehavior`.
        this._finishRenderOpened();
    }

    _renderClosed() {
        this.classList.remove('gfs-toast-open');
        // from `IronOverlayBehavior`.
...
window.customElements.define(GfsToast.is, GfsToast);
